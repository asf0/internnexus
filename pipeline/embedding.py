...
class QueryEmbeddingService:
    """Pipeline-compatible wrapper around the core embedding service.

    Accepts the same constructor signature as the original service
    (optional *model* override) and resolves settings from the pipeline config.
    """
    ...
    # -- Expose internal attributes for test compatibility --

...
Usage:
    ...
    uv run python -m pipeline.consolidate_categories --dry-run

    # Apply consolidation
    uv run python -m pipeline.consolidate_categories

    # Show statistics only
    uv run python -m pipeline.consolidate_categories --stats
"""

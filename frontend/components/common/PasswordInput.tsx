      ...
      <div>
        ...
        <div className="relative">
          <input
            ...
            disabled={disabled}
            className="block w-full px-3 py-2 pr-10 border border-slate-300 dark:border-md-outline-variant rounded-lg shadow-sm placeholder-slate-400 focus:outline-none focus:ring-2 focus:ring-md-primary focus:border-md-primary dark:bg-md-surface-container dark:text-md-on-surface disabled:opacity-50"
        ...
        <div>
          ...
          <div className="relative">
            <input
              ...
              disabled={disabled}
              className={`block w-full px-3 py-2 pr-10 border rounded-lg shadow-sm placeholder-slate-400 focus:outline-none focus:ring-2 focus:ring-md-primary focus:border-md-primary dark:bg-md-surface-container dark:text-md-on-surface disabled:opacity-50 ${

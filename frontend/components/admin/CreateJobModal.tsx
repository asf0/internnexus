  ...
  return (
    ...
    >
      <div className="space-y-4">
        ...
        <div className="space-y-4">
          ...
          <div>
            ...
            <textarea
              ...
              disabled={isLoading}
              rows={5}
              className="dark:border-md-outline-variant dark:bg-md-surface-container dark:text-md-on-surface dark:placeholder-md-on-surface-variant focus:border-md-primary focus:ring-md-primary w-full resize-none rounded-lg border border-slate-300 bg-white px-3 py-2.5 text-sm text-slate-900 placeholder-slate-400 focus:ring-1 focus:outline-none disabled:cursor-not-allowed disabled:opacity-50"
            />
          </div>
        </div>

        {/* Optional Fields Section */}
        <div className="dark:border-md-outline-variant space-y-4 border-t border-slate-200 pt-4">
          <h3 className="dark:text-md-on-surface text-sm font-semibold tracking-wide text-slate-900 uppercase">
        ...
        {/* Action Buttons */}
        <div className="dark:border-md-outline-variant flex gap-3 border-t border-slate-200 pt-4">
          <Button variant="secondary" onClick={handleClose} disabled={isLoading} className="flex-1">
            Cancel
          </Button>
          <Button variant="primary" onClick={handleSubmit} disabled={isLoading} className="flex-1">
            {isLoading ? (
              <>

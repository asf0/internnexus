  ...
  return (
    <div className="space-y-6">
      ...
      <header className="space-y-2">
        <p className="dark:text-md-on-surface-variant text-sm font-semibold text-slate-500 uppercase">
          {job.company}
        </p>
        <h1 className="dark:text-md-on-surface text-3xl font-semibold text-slate-900">
          {job.title}
        </h1>
        <p className="dark:text-md-on-surface-variant text-sm text-slate-600">{job.location}</p>
        ...
        {job.posted_at && (
          <div className="dark:text-md-on-surface-variant flex items-center gap-2 pt-2 text-sm text-slate-500">
      ...
      <article
        className="prose prose-headings:text-slate-900 prose-p:text-slate-700 prose-li:text-slate-700 prose-strong:text-slate-900 dark:prose-invert dark:prose-headings:text-md-on-surface dark:prose-p:text-md-on-surface-variant dark:prose-li:text-md-on-surface-variant dark:prose-strong:text-md-on-surface max-w-none"
